...
function find(array, callback) {
  for (let element of array) {
    if (callback(element)) { // Checking if callback returns true with given element
      return element 
    }
  }
  return undefined
...
function filter(array, callback) {
  ...
  for (let element of array) {
    if (callback(element)) { // Checking if callback returns true with given element
      result.push(element) // pushes element into array of results
    }
  }
  return result;
}
...
function map(array, callback) {
  const result = [];
  for (let element of array) { // Checking if callback returns true with given element
      result.push(callback(element)) // pushes element into array of results
  }
  return result;
}
